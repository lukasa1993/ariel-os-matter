...
const EXPECTED_IDS: [u32; 91] = [
    0x000A, 0x000B, 0x000E, 0x000F, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, 0x0018,
    0x0019, 0x0022, 0x0023, 0x0024, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x0040,
    0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076,
    0x0077, 0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x0090, 0x0091, 0x0100, 0x0101, 0x0103, 0x0104,
    0x0105, 0x0106, 0x0107, 0x010A, 0x010B, 0x010C, 0x010D, 0x010F, 0x0110, 0x0130, 0x0140, 0x0141,
    0x0142, 0x0143, 0x0144, 0x0145, 0x0146, 0x0147, 0x0148, 0x0202, 0x0203, 0x0230, 0x0231, 0x023E,
    0x0301, 0x0302, 0x0303, 0x0304, 0x0305, 0x0306, 0x0307, 0x0309, 0x030A, 0x050C, 0x050D, 0x050F,
    0x0510, 0x0511, 0x0512, 0x0513, 0x0514, 0x0840, 0x0850,
];

const EXCLUDED_IDS: [u32; 3] = [0x0074, 0x0142, 0x0143];
const EXCLUDED_NAMES: [&str; 3] = ["Robotic Vacuum Cleaner", "Camera", "Video Doorbell"];
